...
public class StoryPage_Downloads extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     favourite_button.setOnClickListener(new View.OnClickListener() {
         ...
         public void onClick(View v) {
             ...
             final Vibrator vibe = (Vibrator) v.getContext().getSystemService(Context.VIBRATOR_SERVICE);
             vibe.vibrate(80);//80 represents the milliseconds (the duration of the vibration)
             Toast.makeText(StoryPage_Downloads.this, "To Remove From Download LongPress From Downloads Screen", Toast.LENGTH_SHORT).show();
         }
     });
    ...
    private void showAds() {
        ...
        if (SplashScreen.Ad_Network_Name.equals("admob")) {
            ...
            ADS_ADMOB rewarded_ads = new ADS_ADMOB(mRewardedVideoAd, StoryPage_Downloads.this, getString(R.string.Rewarded_ADS_Unit_ID));
...
//        mTTS.speak(text, TextToSpeech.QUEUE_FLUSH, null);
    ...
    public void setWindowFlag(Context activity, final int bits, boolean on) {
        Window win = StoryPage_Downloads.this.getWindow();

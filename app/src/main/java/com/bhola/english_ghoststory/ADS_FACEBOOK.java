...
public class ADS_FACEBOOK {
    ...
    public static void bannerAds(Context context, AdView madView, LinearLayout facebook_bannerAd_layput, String Adunit_ID) {
        ...
        AdListener adListener = new AdListener() {
            @Override
            public void onError(Ad ad, AdError adError) {
                Log.d("TAGA", "bannerAds onError: "+adError.getErrorCode());
            }

            @Override
            public void onAdLoaded(Ad ad) {
                Log.d("TAGA", "onAdLoaded: bannerAds");
            }
            ...
            @Override
            public void onLoggingImpression(Ad ad) {
                Log.d("TAGA", "onLoggingImpression:bannerAds ");
            }
        };
    ...
    public static void Delay_handler(Context mContext, InterstitialAd facebook_IntertitialAds, String string) {
            ...
            public void run() {
                try {
                    if (SplashScreen.Ads_State.equals("active")) {
                        interstitialAd(mContext, facebook_IntertitialAds, string);
                    }
                } catch (Exception e) {
